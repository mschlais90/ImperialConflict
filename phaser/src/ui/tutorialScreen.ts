...
export function renderTutorialScreen(root: HTMLElement, onBack: () => void): void {
  ...
  content.innerHTML = `
    ...
    <section>
      ...
      <p>Every battle involving your empire appears in the <strong>Attack Log</strong> in the upper right. Use the To/From checkboxes to filter incoming and outgoing attacks, click a system name to jump to the battle site, or click View to open the full battle report.</p>
    </section>
